...
class ClassesInfoCache {
    ...
    private CallbackInfo createInfo(Class klass, @Nullable Method[] declaredMethods) {
        ClassesInfoCache classesInfoCache = this;
        Class cls = klass;
        ...
        classesInfoCache.mCallbackMap.put(cls, info);
        classesInfoCache.mHasLifecycleMethods.put(cls, Boolean.valueOf(hasLifecycleMethods));
        return info;
    }
}
