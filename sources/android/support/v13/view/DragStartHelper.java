...
public class DragStartHelper {
    ...
    private final OnLongClickListener mLongClickListener = new C00901();
    private final OnTouchListener mTouchListener = new C00912();
    private final View mView;

    /* renamed from: android.support.v13.view.DragStartHelper$1 */
    class C00901 implements OnLongClickListener {
        C00901() {
        }
    ...
    class C00912 implements OnTouchListener {
        C00912() {
        }
