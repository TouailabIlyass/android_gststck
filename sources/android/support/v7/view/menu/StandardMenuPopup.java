...
final class StandardMenuPopup extends MenuPopup implements OnDismissListener, OnItemClickListener, MenuPresenter, OnKeyListener {
    ...
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C02622();
    private int mContentWidth;
    private final Context mContext;
    private int mDropDownGravity = 0;
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C02611();
    ...
    class C02611 implements OnGlobalLayoutListener {
        C02611() {
        }
    ...
    class C02622 implements OnAttachStateChangeListener {
        C02622() {
        }
    ...
    public StandardMenuPopup(Context context, MenuBuilder menu, View anchorView, int popupStyleAttr, int popupStyleRes, boolean overflowOnly) {
        ...
        this.mPopupMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0249R.dimen.abc_config_prefDialogWidth));
        ...
        if (!this.mWasDismissed) {
            if (this.mAnchorView != null) {
                ...
                if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
                    FrameLayout titleItemView = (FrameLayout) LayoutInflater.from(this.mContext).inflate(C0249R.layout.abc_popup_menu_header_item_layout, listView, false);
