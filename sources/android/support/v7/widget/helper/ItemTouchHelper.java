...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C04302();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C03171();
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C03191();
        private static final Interpolator sDragViewScrollCapInterpolator = new C03202();
        ...
        static class C03202 implements Interpolator {
            C03202() {
            }
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0250R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        class C03211 implements AnimatorUpdateListener {
            C03211() {
            }
        ...
        RecoverAnimation(ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY) {
            ...
            this.mValueAnimator.addUpdateListener(new C03211());
    ...
    class C04302 implements OnItemTouchListener {
        C04302() {
        }
    ...
    class C04325 implements ChildDrawingOrderCallback {
        C04325() {
        }
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (recyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0250R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0250R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
        ...
        if (viewHolder != this.mSelected || i != r11.mActionState) {
            ...
            if (r11.mSelected != null) {
                ...
                if (prevSelected.itemView.getParent() != null) {
                    ...
                    if (prevActionState == 2) {
                        ...
                        currentTranslateX = r11.mTmpPosition[0];
                        currentTranslateY = r11.mTmpPosition[1];
                        animationType2 = animationType;
                        prevSelected2 = prevSelected;
                        prevActionState = 0;
                        i2 = 8;
                        i4 = swipeDir;
                        prevActionState = 2;
                        viewHolder2 = prevSelected2;
                        rv = new RecoverAnimation(prevSelected, animationType, prevActionState, currentTranslateX, currentTranslateY, targetTranslateX2, targetTranslateY2) {
                            public void onAnimationEnd(Animator animation) {
                        ...
                        rv.setDuration(r11.mCallback.getAnimationDuration(r11.mRecyclerView, animationType2, targetTranslateX2 - currentTranslateX, targetTranslateY2 - currentTranslateY));
                        r11.mRecoverAnimations.add(rv);
                        rv.start();
                        preventLayout = true;
                        preventLayout2 = prevSelected2;
                    }
                    animationType = animationType3;
                    getSelectedDxDy(r11.mTmpPosition);
                    currentTranslateX = r11.mTmpPosition[0];
                    ...
                    prevActionState = 2;
                    viewHolder2 = prevSelected2;
                    rv = /* anonymous class already generated */;
                    rv.setDuration(r11.mCallback.getAnimationDuration(r11.mRecyclerView, animationType2, targetTranslateX2 - currentTranslateX, targetTranslateY2 - currentTranslateY));
                    r11.mRecoverAnimations.add(rv);
                    rv.start();
                    preventLayout = true;
            ...
            if (viewHolder != null) {
                ...
                if (i == prevActionState) {
                    ...
                    rvParent = r11.mRecyclerView.getParent();
                    if (rvParent != null) {
                        if (r11.mSelected != null) {
                            z = true;
                        }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C04325();
            }
