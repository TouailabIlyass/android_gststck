    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                id = child.getId();
                if (id == C0249R.id.topPanel) {
                    topPanel = child;
                } else if (id == C0249R.id.buttonPanel) {
                    buttonPanel2 = child;
                } else {
                    if (id != C0249R.id.contentPanel) {
                        if (id != C0249R.id.customPanel) {
                            return false;
                        }
                    }
        ...
        while (i < count2) {
            ...
            if (child != null) {
                ...
                if (child.getVisibility() != 8) {
                    ...
                    LayoutParams lp2 = lp;
                    count = count2;
                    alertDialogLayout.setChildFrame(child2, absoluteGravity, childTop, childWidth, childHeight);
