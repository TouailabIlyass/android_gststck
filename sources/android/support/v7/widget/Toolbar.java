...
public class Toolbar extends ViewGroup {
    ...
    class C04291 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C04291() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C03131 implements ClassLoaderCreator<SavedState> {
            C03131() {
            }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0249R.attr.toolbarStyle);
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C04291();
        this.mShowOverflowMenuRunnable = new C03112();
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0249R.styleable.Toolbar, defStyleAttr, 0);
        this.mTitleTextAppearance = a.getResourceId(C0249R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = a.getResourceId(C0249R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = a.getInteger(C0249R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = a.getInteger(C0249R.styleable.Toolbar_buttonGravity, 48);
        int titleMargin = a.getDimensionPixelOffset(C0249R.styleable.Toolbar_titleMargin, 0);
        if (a.hasValue(C0249R.styleable.Toolbar_titleMargins)) {
            titleMargin = a.getDimensionPixelOffset(C0249R.styleable.Toolbar_titleMargins, titleMargin);
        }
        ...
        int marginStart = a.getDimensionPixelOffset(C0249R.styleable.Toolbar_titleMarginStart, -1);
        if (marginStart >= 0) {
            r0.mTitleMarginStart = marginStart;
        }
        int marginEnd = a.getDimensionPixelOffset(C0249R.styleable.Toolbar_titleMarginEnd, -1);
        if (marginEnd >= 0) {
            r0.mTitleMarginEnd = marginEnd;
        }
        int marginTop = a.getDimensionPixelOffset(C0249R.styleable.Toolbar_titleMarginTop, -1);
        if (marginTop >= 0) {
            r0.mTitleMarginTop = marginTop;
        }
        int marginBottom = a.getDimensionPixelOffset(C0249R.styleable.Toolbar_titleMarginBottom, -1);
        if (marginBottom >= 0) {
            r0.mTitleMarginBottom = marginBottom;
        }
        r0.mMaxButtonHeight = a.getDimensionPixelSize(C0249R.styleable.Toolbar_maxButtonHeight, -1);
        int contentInsetStart = a.getDimensionPixelOffset(C0249R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int contentInsetEnd = a.getDimensionPixelOffset(C0249R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        int contentInsetLeft = a.getDimensionPixelSize(C0249R.styleable.Toolbar_contentInsetLeft, 0);
        int contentInsetRight = a.getDimensionPixelSize(C0249R.styleable.Toolbar_contentInsetRight, 0);
        ensureContentInsets();
        ...
        r0.mContentInsetStartWithNavigation = a.getDimensionPixelOffset(C0249R.styleable.Toolbar_contentInsetStartWithNavigation, Integer.MIN_VALUE);
        r0.mContentInsetEndWithActions = a.getDimensionPixelOffset(C0249R.styleable.Toolbar_contentInsetEndWithActions, Integer.MIN_VALUE);
        r0.mCollapseIcon = a.getDrawable(C0249R.styleable.Toolbar_collapseIcon);
        r0.mCollapseDescription = a.getText(C0249R.styleable.Toolbar_collapseContentDescription);
        CharSequence title = a.getText(C0249R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(title)) {
            setTitle(title);
        }
        CharSequence subtitle = a.getText(C0249R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(subtitle)) {
            setSubtitle(subtitle);
        }
        r0.mPopupContext = getContext();
        setPopupTheme(a.getResourceId(C0249R.styleable.Toolbar_popupTheme, 0));
        Drawable navIcon = a.getDrawable(C0249R.styleable.Toolbar_navigationIcon);
        if (navIcon != null) {
            setNavigationIcon(navIcon);
        }
        CharSequence navDesc = a.getText(C0249R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(navDesc)) {
            setNavigationContentDescription(navDesc);
        }
        navIcon = a.getDrawable(C0249R.styleable.Toolbar_logo);
        if (navIcon != null) {
            setLogo(navIcon);
        }
        CharSequence logoDesc = a.getText(C0249R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(logoDesc)) {
            setLogoDescription(logoDesc);
        }
        if (a.hasValue(C0249R.styleable.Toolbar_titleTextColor)) {
            i = -1;
            setTitleTextColor(a.getColor(C0249R.styleable.Toolbar_titleTextColor, -1));
        } else {
            i = -1;
        }
        if (a.hasValue(C0249R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(a.getColor(C0249R.styleable.Toolbar_subtitleTextColor, i));
        }
        a.recycle();
    }
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, C0249R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, C0249R.attr.toolbarNavigationButtonStyle);
            ...
            this.mCollapseButtonView.setOnClickListener(new C03123());
        }
    }
