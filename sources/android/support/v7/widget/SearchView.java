...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C02983 implements OnFocusChangeListener {
        C02983() {
        }
    ...
    class C02994 implements OnLayoutChangeListener {
        C02994() {
        }
    ...
    class C03016 implements OnKeyListener {
        C03016() {
        }
    ...
    class C03027 implements OnEditorActionListener {
        C03027() {
        }
    ...
    class C03038 implements OnItemClickListener {
        C03038() {
        }
    ...
    class C03049 implements OnItemSelectedListener {
        C03049() {
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C03051 implements ClassLoaderCreator<SavedState> {
            C03051() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0249R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attrs, int defStyle) {
            super(context, attrs, defStyle);
            this.mRunShowSoftInputIfNecessary = new C03061();
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0249R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mUpdateDrawableStateRunnable = new C02961();
        this.mReleaseCursorRunnable = new C02972();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C03005();
        this.mTextKeyListener = new C03016();
        this.mOnEditorActionListener = new C03027();
        this.mOnItemClickListener = new C03038();
        this.mOnItemSelectedListener = new C03049();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0249R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0249R.styleable.SearchView_layout, C0249R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0249R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0249R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0249R.id.search_plate);
        this.mSubmitArea = findViewById(C0249R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0249R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0249R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0249R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0249R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0249R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0249R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0249R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0249R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0249R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0249R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0249R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0249R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0249R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0249R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0249R.styleable.SearchView_suggestionRowLayout, C0249R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0249R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02983());
        setIconifiedByDefault(a.getBoolean(C0249R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0249R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0249R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0249R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0249R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0249R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0249R.styleable.SearchView_android_focusable, true));
        a.recycle();
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C02994());
        }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0249R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0249R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0249R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0249R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    boolean onItemClicked(int position, int actionKey, String actionMsg) {
        if (this.mOnSuggestionListener != null) {
            if (this.mOnSuggestionListener.onSuggestionClick(position)) {
                return false;
            }
        }
    ...
    boolean onItemSelected(int position) {
        if (this.mOnSuggestionListener != null) {
            if (this.mOnSuggestionListener.onSuggestionSelect(position)) {
                return false;
            }
        }
