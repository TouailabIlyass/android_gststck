...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        public void show() {
            ...
            if (!wasShowing) {
                ...
                if (vto != null) {
                    final OnGlobalLayoutListener layoutListener = new C02742();
    ...
    public AppCompatSpinner(Context context, int mode) {
        this(context, null, C0249R.attr.spinnerStyle, mode);
    }

    public AppCompatSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, C0249R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(android.content.Context r9, android.util.AttributeSet r10, int r11, int r12, android.content.res.Resources.Theme r13) {
        ...
        r0.<init>();
        r8.mTempRect = r0;
        r0 = android.support.v7.appcompat.C0249R.styleable.Spinner;
        r1 = 0;
    ...
    L_0x001b:
        ...
        goto L_0x003e;
    L_0x0023:
        r3 = android.support.v7.appcompat.C0249R.styleable.Spinner_popupTheme;
    ...
    L_0x0074:
        ...
        r3.<init>(r5, r10, r11);
        r5 = r8.mPopupContext;
        r6 = android.support.v7.appcompat.C0249R.styleable.Spinner;
        r1 = android.support.v7.widget.TintTypedArray.obtainStyledAttributes(r5, r10, r6, r11, r1);
        r5 = android.support.v7.appcompat.C0249R.styleable.Spinner_android_dropDownWidth;
        r6 = -2;
        r5 = r1.getLayoutDimension(r5, r6);
        r8.mDropDownWidth = r5;
        r5 = android.support.v7.appcompat.C0249R.styleable.Spinner_android_popupBackground;
        r5 = r1.getDrawable(r5);
        r3.setBackgroundDrawable(r5);
        r5 = android.support.v7.appcompat.C0249R.styleable.Spinner_android_prompt;
        r5 = r0.getString(r5);
        r3.setPromptText(r5);
        r1.recycle();
        r8.mPopup = r3;
    ...
    L_0x00aa:
        r1 = android.support.v7.appcompat.C0249R.styleable.Spinner_android_entries;
    ...
    L_0x00b2:
        ...
        r3.<init>(r9, r5, r1);
        r5 = android.support.v7.appcompat.C0249R.layout.support_simple_spinner_dropdown_item;
