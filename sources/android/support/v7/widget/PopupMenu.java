...
public class PopupMenu {
    ...
    class C02902 implements android.widget.PopupWindow.OnDismissListener {
        C02902() {
        }
    ...
    class C04211 implements Callback {
        C04211() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0249R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C04211());
        ...
        this.mPopup.setOnDismissListener(new C02902());
    }
