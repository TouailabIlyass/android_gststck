...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs) {
        this(context, attrs, C0249R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0249R.styleable.ActionMode, defStyle, 0);
        ViewCompat.setBackground(this, a.getDrawable(C0249R.styleable.ActionMode_background));
        this.mTitleStyleRes = a.getResourceId(C0249R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = a.getResourceId(C0249R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = a.getLayoutDimension(C0249R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = a.getResourceId(C0249R.styleable.ActionMode_closeItemLayout, C0249R.layout.abc_action_mode_close_item_material);
        a.recycle();
    }
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0249R.layout.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0249R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0249R.id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        this.mClose.findViewById(C0249R.id.action_mode_close_button).setOnClickListener(new OnClickListener() {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != 1073741824) {
            ...
            if (viewParent.mCustomView != null) {
                ...
                viewParent.mCustomView.measure(MeasureSpec.makeMeasureSpec(lp2.width >= 0 ? Math.min(lp2.width, availableWidth) : availableWidth, customWidthMode), MeasureSpec.makeMeasureSpec(lp2.height >= 0 ? Math.min(lp2.height, height) : height, lp2.height != -2 ? 1073741824 : Integer.MIN_VALUE));
            }
            if (viewParent.mContentHeight <= 0) {
                widthMode = 0;
