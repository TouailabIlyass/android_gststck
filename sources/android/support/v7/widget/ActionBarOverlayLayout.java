...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0249R.attr.actionBarSize, 16842841};
    ...
    class C02651 extends AnimatorListenerAdapter {
        C02651() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C02651();
        this.mRemoveActionBarHideOffset = new C02662();
        this.mAddActionBarHideOffset = new C02673();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0249R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0249R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0249R.id.action_bar));
        }
    }
