...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(C0249R.attr.actionBarPopupTheme, tv, true) || tv.resourceId == 0) {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0249R.styleable.ActionBar, C0249R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0249R.styleable.ActionBar_height, 0));
        a.recycle();
