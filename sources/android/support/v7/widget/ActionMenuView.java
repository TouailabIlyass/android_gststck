    ...
    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (cellsRemaining2 <= 0 || smallestItemsAt == 0) {
            ...
            if (singleItem) {
                ...
                i3 = childCount;
                if (!((smallestItemsAt & ((long) (1 << (childCount - 1)))) == 0 || ((LayoutParams) getChildAt(i3 - 1).getLayoutParams()).preventEdgeOffset)) {
                    expandCount -= 0.5f;
                }
            }
            ...
            while (true) {
                ...
                if ((smallestItemsAt & ((long) (true << cellSizeRemaining))) != 0) {
                    ...
                    lp2 = (LayoutParams) singleItem.getLayoutParams();
        ...
        if (needsExpansion) {
            ...
            while (true) {
                ...
                if (lp3.expanded) {
                    child4.measure(MeasureSpec.makeMeasureSpec((lp3.cellsUsed * cellSize) + lp3.extraPixels, 1073741824), itemHeightSpec);
                }
                i4 = i + 1;
            }
        }
