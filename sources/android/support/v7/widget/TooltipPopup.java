...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0249R.layout.abc_tooltip, null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0249R.id.message);
        ...
        this.mLayoutParams.windowAnimations = C0249R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View anchorView, int anchorX, int anchorY, boolean fromTouch, LayoutParams outParams) {
        ...
        int tooltipPreciseAnchorThreshold = this.mContext.getResources().getDimensionPixelOffset(C0249R.dimen.tooltip_precise_anchor_threshold);
        ...
        if (anchorView.getHeight() >= tooltipPreciseAnchorThreshold) {
            offsetAbove = r0.mContext.getResources().getDimensionPixelOffset(C0249R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int tooltipOffset = r0.mContext.getResources().getDimensionPixelOffset(fromTouch ? C0249R.dimen.tooltip_y_offset_touch : C0249R.dimen.tooltip_y_offset_non_touch);
