...
import android.support.v7.recyclerview.C0250R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C02933();
    ...
    static class C02933 implements Interpolator {
        C02933() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C04261();
        ...
        private final Callback mVerticalBoundCheckCallback = new C04272();
        private int mWidth;
        ...
        class C04261 implements Callback {
            C04261() {
            }
        ...
        class C04272 implements Callback {
            C04272() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0250R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0250R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0250R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0250R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0250R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
                        ...
                        if (offsetPosition >= 0) {
                            if (offsetPosition < RecyclerView.this.mAdapter.getItemCount()) {
                                ...
                                if (holder == null) {
                                    ...
                                    if (deadlineNs != RecyclerView.FOREVER_NS && !recycler.mRecyclerPool.willCreateInTime(type, start, deadlineNs)) {
                                        return null;
                                    }
    ...
    class C04234 implements ProcessCallback {
        C04234() {
        }
    ...
    class C04245 implements Callback {
        C04245() {
        }
    ...
    class C04256 implements Callback {
        C04256() {
        }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C02911();
        ...
        r6.mPrefetchRegistry = ALLOW_THREAD_GAP_WORK ? new LayoutPrefetchRegistryImpl() : null;
        r6.mState = new State();
        r6.mItemsAddedOrRemoved = false;
        r6.mItemsChanged = false;
        r6.mItemAnimatorListener = new ItemAnimatorRestoreListener();
        r6.mPostedAnimatorRunner = false;
        r6.mMinMaxLayoutPositions = new int[2];
        r6.mScrollOffset = new int[2];
        r6.mScrollConsumed = new int[2];
        r6.mNestedOffsets = new int[2];
        r6.mPendingAccessibilityImportanceChange = new ArrayList();
        r6.mItemAnimatorRunner = new C02922();
        r6.mViewInfoProcessCallback = new C04234();
        if (attributeSet != null) {
            TypedArray a = context2.obtainStyledAttributes(attributeSet, CLIP_TO_PADDING_ATTR, i, 0);
            r6.mClipToPadding = a.getBoolean(0, true);
            a.recycle();
        } else {
            r6.mClipToPadding = true;
        }
        setScrollContainer(true);
        setFocusableInTouchMode(true);
        ViewConfiguration vc = ViewConfiguration.get(context);
        r6.mTouchSlop = vc.getScaledTouchSlop();
        r6.mScaledHorizontalScrollFactor = ViewConfigurationCompat.getScaledHorizontalScrollFactor(vc, context2);
        r6.mScaledVerticalScrollFactor = ViewConfigurationCompat.getScaledVerticalScrollFactor(vc, context2);
        r6.mMinFlingVelocity = vc.getScaledMinimumFlingVelocity();
        r6.mMaxFlingVelocity = vc.getScaledMaximumFlingVelocity();
        setWillNotDraw(getOverScrollMode() == 2);
        r6.mItemAnimator.setListener(r6.mItemAnimatorListener);
        initAdapterManager();
        initChildrenHelper();
        if (ViewCompat.getImportantForAccessibility(this) == 0) {
            ViewCompat.setImportantForAccessibility(r6, 1);
        }
        r6.mAccessibilityManager = (AccessibilityManager) getContext().getSystemService("accessibility");
        setAccessibilityDelegateCompat(new RecyclerViewAccessibilityDelegate(r6));
        boolean nestedScrollingEnabled = true;
        if (attributeSet != null) {
            TypedArray a2 = context2.obtainStyledAttributes(attributeSet, C0250R.styleable.RecyclerView, i, 0);
            String layoutManagerName = a2.getString(C0250R.styleable.RecyclerView_layoutManager);
            int descendantFocusability = a2.getInt(C0250R.styleable.RecyclerView_android_descendantFocusability, -1);
            if (descendantFocusability == -1) {
                setDescendantFocusability(262144);
            }
            r6.mEnableFastScroller = a2.getBoolean(C0250R.styleable.RecyclerView_fastScrollEnabled, false);
            if (r6.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a2.getDrawable(C0250R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a2.getDrawable(C0250R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a2.getDrawable(C0250R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a2.getDrawable(C0250R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a2.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C04245());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C04256());
    }
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        if (!(verticalThumbDrawable == null || verticalTrackDrawable == null || horizontalThumbDrawable == null)) {
            if (horizontalTrackDrawable != null) {
                ...
                FastScroller fastScroller = new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0250R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0250R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0250R.dimen.fastscroll_margin));
                return;
            }
        }
        StringBuilder stringBuilder = new StringBuilder();
