...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        public Builder setPositiveButtonIcon(Drawable icon) {
            this.f6P.mPositiveButtonIcon = icon;
            return this;
        }
        ...
        public Builder setNegativeButtonIcon(Drawable icon) {
            this.f6P.mNegativeButtonIcon = icon;
            return this;
        }
        ...
        public Builder setNeutralButtonIcon(Drawable icon) {
            this.f6P.mNeutralButtonIcon = icon;
            return this;
        }
    ...
    static int resolveDialogTheme(@NonNull Context context, @StyleRes int resid) {
        ...
        context.getTheme().resolveAttribute(C0249R.attr.alertDialogTheme, outValue, true);
