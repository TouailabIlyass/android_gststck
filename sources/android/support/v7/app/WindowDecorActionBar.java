...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C04641();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C04652();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C04053();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C04053 implements ViewPropertyAnimatorUpdateListener {
        C04053() {
        }
    ...
    class C04652 extends ViewPropertyAnimatorListenerAdapter {
        C04652() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0249R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0249R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0249R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0249R.id.action_bar_container);
            ...
            if (this.mContainerView != null) {
                ...
                if (!abp.enableHomeButtonByDefault()) {
                    if (!homeAsUp) {
                        ...
                        a = this.mContext.obtainStyledAttributes(null, C0249R.styleable.ActionBar, C0249R.attr.actionBarStyle, 0);
                        if (a.getBoolean(C0249R.styleable.ActionBar_hideOnContentScroll, false)) {
                            setHideOnContentScrollEnabled(true);
                        }
                        elevation = a.getDimensionPixelSize(C0249R.styleable.ActionBar_elevation, 0);
                        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0249R.attr.actionBarWidgetTheme, outValue, true);
