...
class AlertController {
    ...
    private final OnClickListener mButtonHandler = new C02351();
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (this.mIsMultiChoice) {
                ...
                if (this.mCursor != null) {
                    adapter2 = new SimpleCursorAdapter(this.mContext, layout, this.mCursor, new String[]{this.mLabelColumn}, new int[]{16908308});
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0249R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0249R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0249R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0249R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0249R.styleable.AlertDialog, C0249R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0249R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0249R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0249R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0249R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0249R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0249R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0249R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = a.getDimensionPixelSize(C0249R.styleable.AlertDialog_buttonIconDimen, 0);
        a.recycle();
    ...
    private void setupView() {
        ...
        int i2;
        ListView listView;
        View parentPanel = this.mWindow.findViewById(C0249R.id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0249R.id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0249R.id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0249R.id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0249R.id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0249R.id.topPanel);
        View customContentPanel = customPanel.findViewById(C0249R.id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0249R.id.buttonPanel);
        ...
        if (!(hasButtonPanel || contentPanel == null)) {
            View spacer = contentPanel.findViewById(C0249R.id.textSpacerNoButtons);
            if (spacer != null) {
                spacer.setVisibility(null);
                if (hasTopPanel) {
                    if (r0.mScrollView != null) {
                        r0.mScrollView.setClipToPadding(true);
                    }
                    parentPanel = null;
                    if (!(r0.mMessage == null && r0.mListView == null)) {
                        parentPanel = topPanel.findViewById(C0249R.id.titleDividerNoCustom);
                    }
                    if (parentPanel != null) {
                        parentPanel.setVisibility(0);
                    }
                } else if (contentPanel != null) {
                    parentPanel = contentPanel.findViewById(C0249R.id.textSpacerNoTitle);
                    if (parentPanel != null) {
                        i = 0;
                        parentPanel.setVisibility(0);
                        if (r0.mListView instanceof RecycleListView) {
                            ((RecycleListView) r0.mListView).setHasDecor(hasTopPanel, hasButtonPanel);
                        }
                        if (!hasCustomPanel) {
                            parentPanel = r0.mListView == null ? r0.mListView : r0.mScrollView;
                            if (parentPanel != null) {
                                i2 = hasTopPanel ? 1 : i;
                                if (hasButtonPanel) {
                                    i = 2;
                                }
                                setScrollIndicators(contentPanel, parentPanel, i2 | i, 3);
                                listView = r0.mListView;
                                if (listView != null && r0.mAdapter != null) {
                                    listView.setAdapter(r0.mAdapter);
                                    int checkedItem = r0.mCheckedItem;
                                    if (checkedItem > -1) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0249R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0249R.id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0249R.id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0249R.id.title_template).setVisibility(8);
            return;
        }
        this.mIconView = (ImageView) this.mWindow.findViewById(16908294);
        if ((TextUtils.isEmpty(this.mTitle) ^ 1) && this.mShowTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0249R.id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0249R.id.scrollView);
