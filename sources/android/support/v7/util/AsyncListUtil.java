...
public class AsyncListUtil<T> {
    ...
    private final BackgroundCallback<T> mBackgroundCallback = new C04082();
    final BackgroundCallback<T> mBackgroundProxy;
    final DataCallback<T> mDataCallback;
    int mDisplayedGeneration = 0;
    int mItemCount = 0;
    private final MainThreadCallback<T> mMainThreadCallback = new C04071();
    ...
    class C04071 implements MainThreadCallback<T> {
        C04071() {
        }
    ...
    class C04082 implements BackgroundCallback<T> {
