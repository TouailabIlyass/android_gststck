...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C02321();
    ...
    private final Runnable mSetIdleRunnable = new C02332();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    /* renamed from: android.support.v4.widget.ViewDragHelper$1 */
    static class C02321 implements Interpolator {
        C02321() {
        }
