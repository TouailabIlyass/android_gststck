...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C02221();
        boolean isOpen;

        /* renamed from: android.support.v4.widget.SlidingPaneLayout$SavedState$1 */
        static class C02221 implements ClassLoaderCreator<SavedState> {
            C02221() {
            }
            ...
            if (child.getVisibility() == 8) {
                ...
                if (lp.width == -2) {
                    ...
                    if (lp.height == -2) {
                        ...
                        i = MeasureSpec.makeMeasureSpec(maxLayoutHeight2, 1073741824);
                    } else {
                    ...
                    if (!canSlide || child == slidingPaneLayout.mSlideableView) {
                        ...
                        if (lp2.weight > 0) {
                            if (lp2.width != 0) {
                                ...
                                heightMode = MeasureSpec.makeMeasureSpec(maxLayoutHeight2, 1073741824);
                            } else {
                            ...
                            if (canSlide) {
                                ...
                                maxLayoutHeight2 = MeasureSpec.makeMeasureSpec(childCount2, 1073741824);
                                if (i != childCount2) {
                        ...
                        if (skippedFirstPass) {
                            ...
                            if (lp2.height == -2) {
                                ...
                                heightMode = 1073741824;
                                childCount2 = MeasureSpec.makeMeasureSpec(maxLayoutHeight2, 1073741824);
                            } else {
                                heightMode = 1073741824;
                                childCount2 = MeasureSpec.makeMeasureSpec(lp2.height, 1073741824);
                            }
                        } else {
                            childCount = childCount2;
                            heightMode = 1073741824;
                            childCount2 = MeasureSpec.makeMeasureSpec(child.getMeasuredHeight(), 1073741824);
                        }
