...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C02231 implements AnimationListener {
        C02231() {
        }
    ...
    class C02242 extends Animation {
        C02242() {
        }
    ...
    class C02253 extends Animation {
        C02253() {
        }
    ...
    class C02275 implements AnimationListener {
        C02275() {
        }
    ...
    class C02286 extends Animation {
        C02286() {
        }
    ...
    class C02297 extends Animation {
        C02297() {
        }
    ...
    class C02308 extends Animation {
        C02308() {
        }
    ...
    public SwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        this.mRefreshListener = new C02231();
        this.mAnimateToCorrectPosition = new C02286();
        this.mAnimateToStartPosition = new C02297();
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C02242();
    ...
    void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C02253();
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        r0.mProgress.setProgressRotation(((-0.25f + (0.4f * adjustedPercent)) + (DECELERATE_INTERPOLATION_FACTOR * tensionPercent)) * DRAG_RATE);
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C02308();
