...
public class FontsContractCompat {
    ...
    private static final Comparator<byte[]> sByteArrayComparator = new C01935();
    ...
    static class C01935 implements Comparator<byte[]> {
        C01935() {
        }
    ...
    public static void requestFont(@NonNull final Context context, @NonNull final FontRequest request, @NonNull final FontRequestCallback callback, @NonNull Handler handler) {
        ...
        handler.post(new Runnable() {
            ...
            class C01875 implements Runnable {
                C01875() {
                }
            ...
            class C01908 implements Runnable {
                C01908() {
                }
                ...
                try {
                    ...
                    if (result.getStatusCode() != 0) {
                        switch (result.getStatusCode()) {
                            case 1:
                                callerThreadHandler.post(new C01842());
                                return;
                            case 2:
                                callerThreadHandler.post(new C01853());
                                return;
                            default:
                                callerThreadHandler.post(new C01864());
                                return;
                        }
                    }
                        ...
                        if (fonts.length != 0) {
                            for (FontInfo font : fonts) {
                                if (font.getResultCode() != 0) {
                                    ...
                                    if (resultCode < 0) {
                                        callerThreadHandler.post(new C01886());
                                    } else {
                            ...
                            if (typeface == null) {
                                callerThreadHandler.post(new C01908());
                                return;
                            } else {
                                callerThreadHandler.post(new Runnable() {
                                    public void run() {
                    ...
                    callerThreadHandler.post(new C01875());
                } catch (NameNotFoundException e) {
                    callerThreadHandler.post(new C01831());
                }
            }
        });
    }
