...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C03791 implements StyleExtractor<FontInfo> {
        C03791() {
        }
    ...
    class C03802 implements StyleExtractor<FontFileResourceEntry> {
        C03802() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fonts, int style) {
        return (FontInfo) findBestFont(fonts, style, new C03791());
    }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry entry, int style) {
        return (FontFileResourceEntry) findBestFont(entry.getEntries(), style, new C03802());
    }
