...
public final class MediaMetadataCompat implements Parcelable {
    public static final Creator<MediaMetadataCompat> CREATOR = new C01641();
    ...
    static class C01641 implements Creator<MediaMetadataCompat> {
        C01641() {
        }
    ...
    public MediaDescriptionCompat getDescription() {
        ...
        Uri mediaUri = null;
        next4 = getString(METADATA_KEY_MEDIA_URI);
        if (!TextUtils.isEmpty(next4)) {
