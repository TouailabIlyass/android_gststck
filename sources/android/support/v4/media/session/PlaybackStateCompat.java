...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01731();
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01741();
    ...
    public Object getPlaybackState() {
        if (this.mStateObj == null && VERSION.SDK_INT >= 21) {
            ...
            if (r0.mCustomActions != null) {
                customActions = new ArrayList(r0.mCustomActions.size());
                for (CustomAction customAction : r0.mCustomActions) {
                    customActions.add(customAction.getCustomAction());
                }
            }
            if (VERSION.SDK_INT >= 22) {
                r0.mStateObj = PlaybackStateCompatApi22.newInstance(r0.mState, r0.mPosition, r0.mBufferedPosition, r0.mSpeed, r0.mActions, r0.mErrorMessage, r0.mUpdateTime, customActions, r0.mActiveItemId, r0.mExtras);
            } else {
                r0.mStateObj = PlaybackStateCompatApi21.newInstance(r0.mState, r0.mPosition, r0.mBufferedPosition, r0.mSpeed, r0.mActions, r0.mErrorMessage, r0.mUpdateTime, customActions, r0.mActiveItemId);
            }
        }
        return r0.mStateObj;
    }
