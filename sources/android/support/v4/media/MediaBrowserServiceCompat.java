...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    private class ConnectionRecord implements DeathRecipient {
        ...
        public void binderDied() {
            MediaBrowserServiceCompat.this.mHandler.post(new C01491());
        }
    }
                    ...
                    public void run() {
                        ...
                        if (connection.root == null) {
                            ...
                            try {
                                ...
                                stringBuilder2.append("Calling onConnectFailed() failed. Ignoring. pkg=");
                        ...
                        try {
                            ...
                            str2 = MediaBrowserServiceCompat.TAG;
