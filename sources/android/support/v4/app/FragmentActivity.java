...
public class FragmentActivity extends BaseFragmentActivityApi16 implements ViewModelStoreOwner, OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    public void startIntentSenderFromFragment(Fragment fragment, IntentSender intent, int requestCode, @Nullable Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags, Bundle options) throws SendIntentException {
        ...
        if (i == -1) {
            try {
                ActivityCompat.startIntentSenderForResult(r9, intent, i, fillInIntent, flagsMask, flagsValues, extraFlags, options);
            ...
            BaseFragmentActivityApi14.checkForValidRequestCode(requestCode);
            ActivityCompat.startIntentSenderForResult(r9, intent, ((allocateRequestIndex(fragment) + 1) << 16) + (SupportMenu.USER_MASK & i), fillInIntent, flagsMask, flagsValues, extraFlags, options);
            r9.mStartedIntentSenderFromFragment = false;
        }
    }
