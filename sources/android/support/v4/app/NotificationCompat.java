...
import android.support.compat.C0010R;
...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) {
            ...
            if (VERSION.SDK_INT >= 16 && VERSION.SDK_INT < 21) {
                if (minPriority) {
                    contentView.setInt(C0010R.id.notification_background, "setBackgroundResource", C0010R.drawable.notification_bg_low);
                    contentView.setInt(C0010R.id.icon, "setBackgroundResource", C0010R.drawable.notification_template_icon_low_bg);
                } else {
                    contentView.setInt(C0010R.id.notification_background, "setBackgroundResource", C0010R.drawable.notification_bg);
                    contentView.setInt(C0010R.id.icon, "setBackgroundResource", C0010R.drawable.notification_template_icon_bg);
                }
            }
            if (r0.mBuilder.mLargeIcon != null) {
                if (VERSION.SDK_INT >= 16) {
                    contentView.setViewVisibility(C0010R.id.icon, 0);
                    contentView.setImageViewBitmap(C0010R.id.icon, r0.mBuilder.mLargeIcon);
                } else {
                    contentView.setViewVisibility(C0010R.id.icon, 8);
                }
                if (showSmallIcon && r0.mBuilder.mNotification.icon != 0) {
                    int backgroundSize = res.getDimensionPixelSize(C0010R.dimen.notification_right_icon_size);
                    int iconSize = backgroundSize - (res.getDimensionPixelSize(C0010R.dimen.notification_small_icon_background_padding) * 2);
                    if (VERSION.SDK_INT >= 21) {
                        contentView.setImageViewBitmap(C0010R.id.right_icon, createIconWithBackground(r0.mBuilder.mNotification.icon, backgroundSize, iconSize, r0.mBuilder.getColor()));
                    } else {
                        contentView.setImageViewBitmap(C0010R.id.right_icon, createColoredBitmap(r0.mBuilder.mNotification.icon, -1));
                    }
                    contentView.setViewVisibility(C0010R.id.right_icon, 0);
                }
            } else if (showSmallIcon && r0.mBuilder.mNotification.icon != 0) {
                contentView.setViewVisibility(C0010R.id.icon, 0);
                if (VERSION.SDK_INT >= 21) {
                    contentView.setImageViewBitmap(C0010R.id.icon, createIconWithBackground(r0.mBuilder.mNotification.icon, res.getDimensionPixelSize(C0010R.dimen.notification_large_icon_width) - res.getDimensionPixelSize(C0010R.dimen.notification_big_circle_margin), res.getDimensionPixelSize(C0010R.dimen.notification_small_icon_size_as_large), r0.mBuilder.getColor()));
                } else {
                    contentView.setImageViewBitmap(C0010R.id.icon, createColoredBitmap(r0.mBuilder.mNotification.icon, -1));
                }
            }
            if (r0.mBuilder.mContentTitle != null) {
                contentView.setTextViewText(C0010R.id.title, r0.mBuilder.mContentTitle);
            }
            if (r0.mBuilder.mContentText != null) {
                contentView.setTextViewText(C0010R.id.text, r0.mBuilder.mContentText);
                showLine3 = true;
            }
            boolean z = VERSION.SDK_INT < 21 && r0.mBuilder.mLargeIcon != null;
            if (r0.mBuilder.mContentInfo != null) {
                contentView.setTextViewText(C0010R.id.info, r0.mBuilder.mContentInfo);
                contentView.setViewVisibility(C0010R.id.info, 0);
                showLine3 = true;
                z = true;
            } else if (r0.mBuilder.mNumber > 0) {
                if (r0.mBuilder.mNumber > res.getInteger(C0010R.integer.status_bar_notification_info_maxnum)) {
                    contentView.setTextViewText(C0010R.id.info, res.getString(C0010R.string.status_bar_notification_info_overflow));
                } else {
                    contentView.setTextViewText(C0010R.id.info, NumberFormat.getIntegerInstance().format((long) r0.mBuilder.mNumber));
                }
                contentView.setViewVisibility(C0010R.id.info, 0);
                showLine3 = true;
                z = true;
            } else {
                contentView.setViewVisibility(C0010R.id.info, 8);
            }
            ...
            if (r0.mBuilder.mSubText == null || VERSION.SDK_INT < 16) {
                ...
                contentView.setTextViewText(C0010R.id.text, r0.mBuilder.mSubText);
                if (r0.mBuilder.mContentText != null) {
                    contentView.setTextViewText(C0010R.id.text2, r0.mBuilder.mContentText);
                    contentView.setViewVisibility(C0010R.id.text2, 0);
                    showLine2 = true;
                    i = 8;
                    if (showLine2 || VERSION.SDK_INT < 16) {
                        ...
                        if (fitIn1U) {
                            contentView.setTextViewTextSize(C0010R.id.text, 0, (float) res.getDimensionPixelSize(C0010R.dimen.notification_subtext_size));
                        }
                        i2 = i;
                        contentView.setViewPadding(C0010R.id.line1, 0, 0, 0, 0);
                    }
                    if (r0.mBuilder.getWhenIfShowing() != 0) {
                        if (r0.mBuilder.mUseChronometer || VERSION.SDK_INT < 16) {
                            contentView.setViewVisibility(C0010R.id.time, 0);
                            contentView.setLong(C0010R.id.time, "setTime", r0.mBuilder.getWhenIfShowing());
                        } else {
                            contentView.setViewVisibility(C0010R.id.chronometer, 0);
                            contentView.setLong(C0010R.id.chronometer, "setBase", r0.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                            contentView.setBoolean(C0010R.id.chronometer, "setStarted", true);
                        }
                        showLine3 = true;
                    }
                    contentView.setViewVisibility(C0010R.id.right_side, showLine3 ? 0 : i2);
                    i3 = C0010R.id.line3;
                    if (showLine32) {
                        i4 = i2;
                    }
                ...
                i = 8;
                contentView.setViewVisibility(C0010R.id.text2, 8);
            }
            showLine2 = false;
            if (showLine2) {
            }
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            Bitmap coloredBitmap = createColoredBitmap(C0010R.drawable.notification_icon_background, color == 0 ? 0 : color, size);
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0010R.id.notification_main_column);
            outerView.addView(C0010R.id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0010R.id.notification_main_column, 0);
            if (VERSION.SDK_INT >= 21) {
                outerView.setViewPadding(C0010R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0010R.id.title, 8);
            outerView.setViewVisibility(C0010R.id.text2, 8);
            outerView.setViewVisibility(C0010R.id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            float largeFactor = (constrain(resources.getConfiguration().fontScale, 1.0f, 1.3f) - 1.0f) / 0.29999995f;
            return Math.round(((1.0f - largeFactor) * ((float) resources.getDimensionPixelSize(C0010R.dimen.notification_top_pad))) + (((float) resources.getDimensionPixelSize(C0010R.dimen.notification_top_pad_large_text)) * largeFactor));
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            ...
            RemoteViews remoteViews = applyStandardTemplate(true, C0010R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C0010R.id.actions);
            ...
            if (showActions && this.mBuilder.mActions != null) {
                ...
                if (numActions > 0) {
                    ...
                    for (int i = 0; i < numActions; i++) {
                        remoteViews.addView(C0010R.id.actions, generateActionButton((Action) this.mBuilder.mActions.get(i)));
                    }
                }
            }
            if (!actionsVisible) {
            ...
            remoteViews.setViewVisibility(C0010R.id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0010R.id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? C0010R.layout.notification_action_tombstone : C0010R.layout.notification_action);
            button.setImageViewBitmap(C0010R.id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0010R.color.notification_action_color_filter)));
            button.setTextViewText(C0010R.id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0010R.id.action_container, action.actionIntent);
            }
            if (VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0010R.id.action_container, action.title);
            }
            return button;
        }
    }
