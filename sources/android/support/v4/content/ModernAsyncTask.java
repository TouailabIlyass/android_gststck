...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C01241();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C03782();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C01241 implements ThreadFactory {
    ...
    class C03782 extends WorkerRunnable<Params, Result> {
        C03782() {
        }
