...
public final class ResourcesCompat {
    ...
    private static Typeface loadFont(@NonNull Context context, Resources wrapper, TypedValue value, int id, int style, @Nullable FontCallback fontCallback, @Nullable Handler handler, boolean isRequestFromLayoutInflator) {
        ...
        if (typedValue.string == null) {
            ...
            stringBuilder2.append(resources.getResourceName(i2));
        ...
        if (file.startsWith("res/")) {
            Typeface typeface2 = TypefaceCompat.findFromCache(resources, i2, i3);
            if (typeface2 != null) {
            ...
            try {
                if (file.toLowerCase().endsWith(".xml")) {
                    try {
                        XmlResourceParser rp = resources.getXml(i2);
                        FamilyResourceEntry familyEntry = FontResourcesParserCompat.parse(rp, resources);
                        if (familyEntry == null) {
                            try {
                ...
                i = -3;
                try {
                    typeface2 = TypefaceCompat.createFromResourcesFontFile(context, resources, i2, file, i3);
                    if (fontCallback2 != null) {
                        if (typeface2 != null) {
                            try {
                                fontCallback2.callbackSuccessAsync(typeface2, handler2);
