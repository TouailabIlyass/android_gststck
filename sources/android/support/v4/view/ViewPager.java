...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C02081();
    ...
    private static final Interpolator sInterpolator = new C02092();
    ...
    private final Runnable mEndScrollRunnable = new C02103();
    ...
    static class C02081 implements Comparator<ItemInfo> {
        C02081() {
        }
    ...
    static class C02092 implements Interpolator {
        C02092() {
        }
    ...
    class C03974 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C02111 implements ClassLoaderCreator<SavedState> {
            C02111() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03974());
    }
