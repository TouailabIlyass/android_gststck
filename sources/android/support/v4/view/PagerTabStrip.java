...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    class C02062 implements OnClickListener {
        C02062() {
        }
    ...
    public PagerTabStrip(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        this.mPrevText.setOnClickListener(new C02051());
        this.mNextText.setFocusable(true);
        this.mNextText.setOnClickListener(new C02062());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.mDrawFullUnderline) {
            r0.mTabPaint.setColor(ViewCompat.MEASURED_STATE_MASK | (r0.mIndicatorColor & ViewCompat.MEASURED_SIZE_MASK));
            canvas.drawRect((float) getPaddingLeft(), (float) (height - r0.mFullUnderlineHeight), (float) (getWidth() - getPaddingRight()), (float) height, r0.mTabPaint);
        }
    }
