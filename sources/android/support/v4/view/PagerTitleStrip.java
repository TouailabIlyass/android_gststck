...
public class PagerTitleStrip extends ViewGroup {
    ...
    void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        halfCurrWidth = r0.mCurrText.getBaseline();
        textPaddedLeft = r0.mNextText.getBaseline();
        ...
        halfCurrWidth = currTopOffset + r0.mCurrText.getMeasuredHeight();
        textPaddedRight = Math.max(Math.max(currWidth, halfCurrWidth), nextTopOffset + r0.mNextText.getMeasuredHeight());
        ...
        r0.mCurrText.layout(currLeft, halfCurrWidth, i, r0.mCurrText.getMeasuredHeight() + halfCurrWidth);
        paddingTop = Math.min(paddingLeft, (currLeft - r0.mScaledTextSpacing) - prevWidth);
        r0.mPrevText.layout(paddingTop, currWidth, paddingTop + prevWidth, r0.mPrevText.getMeasuredHeight() + currWidth);
        currLeft = Math.max((stripWidth - paddingRight) - nextWidth, r0.mScaledTextSpacing + i);
        r0.mNextText.layout(currLeft, stripHeight, currLeft + nextWidth, r0.mNextText.getMeasuredHeight() + stripHeight);
