...
import android.support.coreui.C0017R;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            ...
            this.mBehaviorResolved = a.hasValue(C0017R.styleable.CoordinatorLayout_Layout_layout_behavior);
    ...
    class C03651 implements OnApplyWindowInsetsListener {
        C03651() {
        }
    ...
    protected static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C00381();
        SparseArray<Parcelable> behaviorStates;

        /* renamed from: android.support.design.widget.CoordinatorLayout$SavedState$1 */
        static class C00381 implements ClassLoaderCreator<SavedState> {
            C00381() {
            }
            ...
            if (widthUsed < childCount) {
                ...
                if (child.getVisibility() == 8) {
                    ...
                    if (b != null) {
                        ...
                        childCount2 = childCount;
                        heightMode2 = heightMode;
                        if (!b.onMeasureChild(coordinatorLayout, child4, childWidthMeasureSpec, keylineWidthUsed, childHeightMeasureSpec, 0)) {
                        }
                        child = child3;
            ...
            if (i3 < childCount) {
                ...
                if (view.getVisibility() != 8) {
                    ...
                    if (viewBehavior != null) {
                        boolean accepted = viewBehavior.onStartNestedScroll(coordinatorLayout, view, child, target, axes, i);
        ...
        while (true) {
            ...
            if (i4 < childCount) {
                ...
                if (lp.isNestedScrollAccepted(i)) {
                    Behavior viewBehavior = lp.getBehavior();
                    if (viewBehavior != null) {
                        viewBehavior.onNestedScrollAccepted(r7, view3, view2, view, i2, i);
                    }
                }
                i3 = i4 + 1;
            } else {
        ...
        while (true) {
            ...
            if (view.getVisibility() == 8) {
                ...
                if (lp.isNestedScrollAccepted(i)) {
                    Behavior viewBehavior = lp.getBehavior();
                    if (viewBehavior != null) {
                        viewBehavior.onNestedScroll(coordinatorLayout, view, target, dxConsumed, dyConsumed, dxUnconsumed, dyUnconsumed, i);
                        accepted = true;
                    }
                }
            }
            ...
            if (view.getVisibility() != 8) {
                ...
                if (lp.isNestedScrollAccepted(type)) {
                    ...
                    if (viewBehavior != null) {
                        ...
                        iArr[0] = 0;
                        viewBehavior.onNestedPreScroll(coordinatorLayout, view, target, dx, dy, coordinatorLayout.mTempIntPair, type);
                        if (dx > 0) {
        ...
        while (true) {
            ...
            if (view.getVisibility() != 8) {
                ...
                if (lp.isNestedScrollAccepted(0)) {
                    Behavior viewBehavior = lp.getBehavior();
                    if (viewBehavior != null) {
                        handled = viewBehavior.onNestedFling(r7, view, target, velocityX, velocityY, consumed) | handled;
                    }
                }
            }
            i = i2 + 1;
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (view.getVisibility() != 8) {
                ...
                if (lp.isNestedScrollAccepted(0)) {
                    Behavior viewBehavior = lp.getBehavior();
                    if (viewBehavior != null) {
                        handled |= viewBehavior.onNestedPreFling(r10, view, target, velocityX, velocityY);
                    }
                }
            }
        }
        ...
        if (VERSION.SDK_INT >= 21) {
            if (ViewCompat.getFitsSystemWindows(this)) {
                if (this.mApplyWindowInsetsListener == null) {
                    this.mApplyWindowInsetsListener = new C03651();
                }
