...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        if (r0.mContentBounds.height() - (2.0f * shadowOffset) > 0.0f) {
            z = true;
        }
        ...
        if (drawHorizontalEdges) {
            ...
            float width = r0.mContentBounds.width() - (2.0f * shadowOffset);
        ...
        if (drawHorizontalEdges) {
            ...
            canvas2.drawRect(0.0f, edgeShadowTop, r0.mContentBounds.width() - (2.0f * shadowOffset), (-r0.mCornerRadius) + r0.mShadowSize, r0.mEdgeShadowPaint);
        } else {
            shadowOffsetHorizontal = shadowScaleHorizontal3;
        }
        canvas2.restoreToCount(saved);
        ...
        if (drawVerticalEdges) {
            ...
            canvas2.drawRect(0.0f, edgeShadowTop, r0.mContentBounds.height() - (2.0f * shadowOffset), -r0.mCornerRadius, r0.mEdgeShadowPaint);
        }
        canvas2.restoreToCount(saved);
        saved = canvas.save();
