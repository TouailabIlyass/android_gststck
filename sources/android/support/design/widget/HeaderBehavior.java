...
abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    final boolean fling(CoordinatorLayout coordinatorLayout, V layout, int minOffset, int maxOffset, float velocityY) {
        ...
        if (this.mFlingRunnable != null) {
            v.removeCallbacks(r0.mFlingRunnable);
            r0.mFlingRunnable = null;
        }
        if (r0.mScroller == null) {
            r0.mScroller = new OverScroller(v.getContext());
        }
        ...
        if (r0.mScroller.computeScrollOffset()) {
            r0.mFlingRunnable = new FlingRunnable(coordinatorLayout, v);
            ViewCompat.postOnAnimation(v, r0.mFlingRunnable);
            return true;
        }
