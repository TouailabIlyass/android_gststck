...
public class BottomNavigationView extends FrameLayout {
    ...
    class C03591 implements Callback {
        C03591() {
        }
        ...
        public boolean onMenuItemSelected(MenuBuilder menu, MenuItem item) {
            ...
            if (BottomNavigationView.this.mReselectedListener == null || item.getItemId() != BottomNavigationView.this.getSelectedItemId()) {
                if (BottomNavigationView.this.mSelectedListener == null || BottomNavigationView.this.mSelectedListener.onNavigationItemSelected(item)) {
                    z = false;
                }
                return z;
            }
    ...
    public BottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0019R.styleable.BottomNavigationView, defStyleAttr, C0019R.style.Widget_Design_BottomNavigationView);
        if (a.hasValue(C0019R.styleable.BottomNavigationView_itemIconTint)) {
            this.mMenuView.setIconTintList(a.getColorStateList(C0019R.styleable.BottomNavigationView_itemIconTint));
        } else {
            this.mMenuView.setIconTintList(createDefaultColorStateList(16842808));
        }
        if (a.hasValue(C0019R.styleable.BottomNavigationView_itemTextColor)) {
            this.mMenuView.setItemTextColor(a.getColorStateList(C0019R.styleable.BottomNavigationView_itemTextColor));
        } else {
            this.mMenuView.setItemTextColor(createDefaultColorStateList(16842808));
        }
        if (a.hasValue(C0019R.styleable.BottomNavigationView_elevation)) {
            ViewCompat.setElevation(this, (float) a.getDimensionPixelSize(C0019R.styleable.BottomNavigationView_elevation, 0));
        }
        this.mMenuView.setItemBackgroundRes(a.getResourceId(C0019R.styleable.BottomNavigationView_itemBackground, 0));
        if (a.hasValue(C0019R.styleable.BottomNavigationView_menu)) {
            inflateMenu(a.getResourceId(C0019R.styleable.BottomNavigationView_menu, 0));
        }
        a.recycle();
        ...
        this.mMenu.setCallback(new C03591());
    }
    ...
    private void addCompatibilityTopDivider(Context context) {
        ...
        divider.setBackgroundColor(ContextCompat.getColor(context, C0019R.color.design_bottom_navigation_shadow_color));
        divider.setLayoutParams(new LayoutParams(-1, getResources().getDimensionPixelSize(C0019R.dimen.design_bottom_navigation_shadow_height)));
        addView(divider);
    }
