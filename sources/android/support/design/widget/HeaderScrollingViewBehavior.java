...
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public boolean onMeasureChild(CoordinatorLayout parent, View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
        ...
        if (header != null) {
            ...
            parent.onMeasureChild(view, parentWidthMeasureSpec, widthUsed, MeasureSpec.makeMeasureSpec((availableHeight - header.getMeasuredHeight()) + getScrollRange(header), childLpHeight == -1 ? 1073741824 : Integer.MIN_VALUE), heightUsed);
            return true;
        }
        view = child;
        return false;
