...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C00363 implements OnTouchListener {
        C00363() {
        }
    ...
    class C03612 extends AccessibilityDelegateCompat {
        C03612() {
        }
    ...
    class C03624 extends BottomSheetCallback {
        C03624() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C03624();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        FrameLayout container = (FrameLayout) View.inflate(getContext(), C0019R.layout.design_bottom_sheet_dialog, null);
        CoordinatorLayout coordinator = (CoordinatorLayout) container.findViewById(C0019R.id.coordinator);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) coordinator.findViewById(C0019R.id.design_bottom_sheet);
        ...
        coordinator.findViewById(C0019R.id.touch_outside).setOnClickListener(new C00351());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C03612());
        bottomSheet.setOnTouchListener(new C00363());
        return container;
    }
    ...
    private static int getThemeResId(Context context, int themeId) {
        ...
        if (context.getTheme().resolveAttribute(C0019R.attr.bottomSheetDialogTheme, outValue, true)) {
            return outValue.resourceId;
        }
        return C0019R.style.Theme_Design_Light_BottomSheetDialog;
    }
}
