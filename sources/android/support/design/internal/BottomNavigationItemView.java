...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int inactiveLabelSize = res.getDimensionPixelSize(C0019R.dimen.design_bottom_navigation_text_size);
        int activeLabelSize = res.getDimensionPixelSize(C0019R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = res.getDimensionPixelSize(C0019R.dimen.design_bottom_navigation_margin);
        ...
        setBackgroundResource(C0019R.drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(C0019R.id.icon);
        this.mSmallLabel = (TextView) findViewById(C0019R.id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0019R.id.largeLabel);
    }
