...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C03521 implements OnApplyWindowInsetsListener {
        C03521() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0019R.styleable.ScrimInsetsFrameLayout, defStyleAttr, C0019R.style.Widget_Design_ScrimInsetsFrameLayout);
        this.mInsetForeground = a.getDrawable(C0019R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03521());
    }
