...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attrs) {
        ...
        this.mInactiveItemMaxWidth = res.getDimensionPixelSize(C0019R.dimen.design_bottom_navigation_item_max_width);
        this.mInactiveItemMinWidth = res.getDimensionPixelSize(C0019R.dimen.design_bottom_navigation_item_min_width);
        this.mActiveItemMaxWidth = res.getDimensionPixelSize(C0019R.dimen.design_bottom_navigation_active_item_max_width);
        this.mItemHeight = res.getDimensionPixelSize(C0019R.dimen.design_bottom_navigation_height);
        ...
        this.mOnClickListener = new C00201();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (inactiveCount = 0; inactiveCount < count; inactiveCount++) {
            ...
            if (child.getVisibility() != 8) {
                child.measure(MeasureSpec.makeMeasureSpec(r0.mTempChildWidths[inactiveCount], 1073741824), heightSpec);
                child.getLayoutParams().width = child.getMeasuredWidth();
                totalWidth += child.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(totalWidth, MeasureSpec.makeMeasureSpec(totalWidth, 1073741824), 0), View.resolveSizeAndState(r0.mItemHeight, heightSpec, 0));
    }
