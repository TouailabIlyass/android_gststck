...
public abstract class Transition implements Cloneable {
    ...
    private static final PathMotion STRAIGHT_PATH_MOTION = new C03731();
    ...
    class C00843 extends AnimatorListenerAdapter {
        C00843() {
        }
    ...
    static class C03731 extends PathMotion {
        C03731() {
        }
                        ...
                        if (z) {
                            ...
                            if (animator != null) {
                                ...
                                if (startValuesListCount == 0) {
                                    ...
                                    i2 = minStartDelay;
                                    runningAnimators.put(startValuesListCount, new AnimationInfo(view2, getName(), transition, ViewUtils.getWindowId(sceneRoot), infoValues));
    ...
    protected void animate(Animator animator) {
        ...
        animator.addListener(new C00843());
        animator.start();
    }
