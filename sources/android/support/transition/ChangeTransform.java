...
public class ChangeTransform extends Transition {
    ...
    private static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(@NonNull Transition transition) {
            ...
            this.mView.setTag(C0082R.id.transition_transform, null);
            this.mView.setTag(C0082R.id.parent_matrix, null);
        }
            ...
            if (matrix != null) {
                if (!matrix.isIdentity()) {
                    ...
                    if (this.mReparent) {
                        ...
                        transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0082R.id.transition_transform));
                        transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0082R.id.parent_matrix));
                    }
                }
            }
            matrix = null;
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues startValues, TransitionValues endValues, boolean handleParentChange) {
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (!this.mIsCanceled) {
                    if (z && ChangeTransform.this.mUseOverlay) {
                        ...
                        view2.setTag(C0082R.id.transition_transform, null);
                        view2.setTag(C0082R.id.parent_matrix, null);
                    }
                }
            ...
            private void setCurrentMatrix(Matrix currentMatrix) {
                ...
                view2.setTag(C0082R.id.transition_transform, this.mTempMatrix);
                transforms2.restore(view2);
            }
        };
    ...
    private void setMatricesForParent(TransitionValues startValues, TransitionValues endValues) {
        ...
        endValues.view.setTag(C0082R.id.parent_matrix, endParentMatrix);
