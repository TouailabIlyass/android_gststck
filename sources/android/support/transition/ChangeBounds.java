            ...
            if (transitionValues2 != null) {
                ...
                if (startParent == null) {
                    ...
                    if (parentMatches(startParent, endParent)) {
                        ...
                        if (numChanges > 0) {
                            ...
                            if (changeBounds.mResizeClip) {
                                ...
                                if (startLeft == endLeft) {
                                    if (startTop == endTop) {
                                        ...
                                        if (startClip3.equals(endClip3) != null) {
                                            ...
                                            i7 = endTop;
                                            endTop = startParent;
                                            c007082 = new AnimatorListenerAdapter() {
                                ...
                                if (startClip3.equals(endClip3) != null) {
                                    ...
                                    i7 = endTop;
                                    endTop = startParent;
                                    c007082 = /* anonymous class already generated */;
                                    endParent.addListener(c00708);
                                }
                                anim = TransitionUtils.mergeAnimators(positionAnimator, endParent);
                            } else {
                        ...
                        viewGroup = sceneRoot;
                        viewGroup.getLocationInWindow(changeBounds.mTempLocation);
