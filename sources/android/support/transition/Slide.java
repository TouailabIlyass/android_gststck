...
public class Slide extends Visibility {
    ...
    private static final CalculateSlide sCalculateBottom = new C04586();
    private static final CalculateSlide sCalculateEnd = new C04575();
    private static final CalculateSlide sCalculateLeft = new C04531();
    private static final CalculateSlide sCalculateRight = new C04564();
    private static final CalculateSlide sCalculateStart = new C04542();
    private static final CalculateSlide sCalculateTop = new C04553();
    ...
    static class C04531 extends CalculateSlideHorizontal {
        C04531() {
            super();
        }
    ...
    static class C04542 extends CalculateSlideHorizontal {
        C04542() {
            super();
        }
    ...
    static class C04553 extends CalculateSlideVertical {
        C04553() {
            super();
        }
    ...
    static class C04564 extends CalculateSlideHorizontal {
        C04564() {
            super();
        }
    ...
    static class C04575 extends CalculateSlideHorizontal {
        C04575() {
            super();
        }
    ...
    static class C04586 extends CalculateSlideVertical {
        C04586() {
            super();
        }
    ...
    public Animator onAppear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ...
        return TranslationAnimationCreator.createAnimation(view2, transitionValues, position[0], position[1], startX, slide.mSlideCalculator.getGoneY(viewGroup, view2), endX, endY, sDecelerate);
    }
    ...
    public Animator onDisappear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ...
        return TranslationAnimationCreator.createAnimation(view2, transitionValues, position[0], position[1], startX, startY, endX, slide.mSlideCalculator.getGoneY(viewGroup, view2), sAccelerate);
    }
}
