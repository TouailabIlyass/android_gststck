    ...
    private static PropertyValuesHolder getPVH(TypedArray styledAttributes, int valueType, int valueFromId, int valueToId, String propertyName) {
        ...
        if (valueType2 == 2) {
            ...
            if (nodesFrom != null) {
                ...
                if (tvFrom == null) {
                    i4 = toType;
                    ofObject = PropertyValuesHolder.ofObject(str, evaluator, new Object[]{nodesFrom});
                } else if (PathParser.canMorph(nodesFrom, tvFrom)) {
                    i4 = toType;
                    ofObject = PropertyValuesHolder.ofObject(str, evaluator, new Object[]{nodesFrom, tvFrom});
                } else {
