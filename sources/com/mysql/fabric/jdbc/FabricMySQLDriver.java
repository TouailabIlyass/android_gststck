...
public class FabricMySQLDriver extends NonRegisteringDriver implements Driver {
    ...
    public Connection connect(String url, Properties info) throws SQLException {
        ...
        try {
            return (Connection) Util.handleNewInstance(Class.forName("com.mysql.fabric.jdbc.JDBC4FabricMySQLConnectionProxy").getConstructor(new Class[]{Properties.class}), new Object[]{parsedProps}, null);
        } catch (Exception e) {
